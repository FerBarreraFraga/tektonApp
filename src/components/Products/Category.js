        ...
        return (
            <SectionList
                ...
                renderSectionHeader={({ section }) =>
                    <View style={{ backgroundColor: sLightGrey, marginBottom: 5, }}>
        ...
        return (
            <View style={styles.screen}>
                <View style={{ marginHorizontal: 20, flex: 1, marginBottom: 30 }}>
                    <TouchableWithoutFeedback onPress={this.goToFavorites}>
                        <Text style={{ textAlign: 'right' }}>Go to Favorites</Text>
                    </TouchableWithoutFeedback>
                    <View style={[
